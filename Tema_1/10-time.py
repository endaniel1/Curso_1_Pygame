...
pygame.display.set_caption("Tiempo -  Time!!") # Damos un titulo a nuestra ventana
...
while True:
	...
	# retorna tiempo transcurrido desde q init fue iniciada
	time = pygame.time.get_ticks() // 1000 # Tiempo dado en milisegundos
	print(time)
