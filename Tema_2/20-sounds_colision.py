...
pygame.display.set_caption("Sonido por colision!") # Damos un titulo a nuestra ventana
...
while True:
	...
	if rect1.colliderect(rect2): # Comprobamos si existe o no una colision de un rectangolo a otro
		sound = pygame.mixer.Sound("../sounds/coin-drop.wav") # Cargamos nuestro sonido
		sound.play() # Reproducimos nuestro sonido
